        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    "ticker": {
                        "type": "string",
                        "description": "사용자 질문에서 추출한 종목코드 또는 종목명입니다. 예: '005930' 또는 '삼성전자'. 사용자가 '삼성전자 주가를 알려줘'라고 하면 '삼성전자'를 추출합니다."
                    },
                    "start_date": {
                        "type": "string",
                        "description": "조회 시작 날짜입니다. YYYY-MM-DD 형식으로 입력하세요. 사용자가 '2024년 데이터'라고 하면 '2024-01-01'을 추출합니다. 기본값은 6개월 전입니다."
                    },
                    "end_date": {
                        "type": "string",
                        "description": "조회 종료 날짜입니다. YYYY-MM-DD 형식으로 입력하세요. 사용자가 '2024년 데이터'라고 하면 '2024-12-31'을 추출합니다. 기본값은 오늘입니다."
                    },
